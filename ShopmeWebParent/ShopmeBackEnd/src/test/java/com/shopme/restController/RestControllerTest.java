...
public class RestControllerTest {
	...
	@Autowired
	public RestControllerTest(MockMvc mockMvc, ObjectMapper objectMapper, CountryRepository repo) {
	...
	@Test
	@WithMockUser(username = "testing54321@gmail.com", password = "1234", roles = "ADMIN")
